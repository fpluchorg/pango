...
func getTests() []testCase {
	return []testCase{
		...
		{version.Number{10, 2, 0, ""}, "empty rule", util.PreRulebase, Entry{
			Name:        "rule1",
			Uuid:        "uuid123",
			GroupTag:    "tag123",
			Description: "blah",
		}},
		{version.Number{10, 2, 0, ""}, "basic rule", util.PreRulebase, Entry{
			Name:                 "rule2",
			Description:          "blah",
			SourceZones:          []string{"zone1", "zone2"},
			SourceAddresses:      []string{"addy1", "grp1"},
		...
		{version.Number{10, 2, 0, ""}, "rule negate source", util.PreRulebase, Entry{
			Name:                 "rule2",
			Description:          "blah",
			SourceZones:          []string{"zone1", "zone2"},
			SourceAddresses:      []string{"addy1", "grp1"},
		...
		{version.Number{10, 2, 0, ""}, "rule negate destination", util.PreRulebase, Entry{
			Name:                 "rule2",
			Description:          "blah",
			SourceZones:          []string{"zone1", "zone2"},
			SourceAddresses:      []string{"addy1", "grp1"},
		...
		{version.Number{10, 2, 0, ""}, "rule disabled", util.PreRulebase, Entry{
			Name:                 "rule2",
			Disabled:             true,
			Description:          "blah",
			SourceZones:          []string{"zone1", "zone2"},
		...
		{version.Number{10, 2, 0, ""}, "rule with logfwd", util.PreRulebase, Entry{
			Name:                 "rule2",
			Description:          "blah",
			SourceZones:          []string{"zone1", "zone2"},
			SourceAddresses:      []string{"addy1", "grp1"},
		...
		{version.Number{10, 2, 0, ""}, "rule with source hips and successful tls logging", util.PreRulebase, Entry{
			Name:                       "rule1",
			Uuid:                       "uuid123",
			GroupTag:                   "tag123",
			Description:                "blah",
		...
		{version.Number{10, 2, 0, ""}, "rule with failed handshakes and log setting", util.PreRulebase, Entry{
			Name:                   "rule1",
			Uuid:                   "uuid123",
			GroupTag:               "tag123",
			Description:            "blah",
		...
		{version.Number{10, 2, 0, ""}, "multi decryption cert", util.PreRulebase, Entry{
			Name:                 "rule2",
			Description:          "blah",
			SourceZones:          []string{"zone1", "zone2"},
			SourceAddresses:      []string{"addy1", "grp1"},
			...
			Action:               ActionNoDecrypt,
			DecryptionType:       DecryptionTypeSslInboundInspection,
			SslCertificates:      []string{"my cert", "cert2"},
			DecryptionProfile:    "decryption profile",
		}},
	}
}
