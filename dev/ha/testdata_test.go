...
func getTests() []testCase {
	return []testCase{
		...
		{"v1 ha active active with raw", version.Number{10, 0, 0, ""}, Config{
			Enable:                 true,
			GroupId:                3,
			Description:            "description",
			...
			AaDeviceId:                 "0",
			AaTentativeHoldTime:        "600",
			AaSyncVirtualRouter:        true,
			AaSyncQos:                  false,
			AaSessionOwnerSelection:    AaSessionOwnerSelectionFirstPacket,
			AaFpSessionSetup:           AaFpSessionSetupIpHash,
			AaFpSessionSetupIpHashKey:  AaFpSessionSetupIpHashKeySourceDest,
			AaFpSessionSetupIpHashSeed: "100",
