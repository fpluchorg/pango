...
func (o *entry_v1) normalize() Entry {
	...
	if o.Collectors != nil {
		raw["collectors"] = util.CleanRawXml(o.Collectors.Text)
	}
...
type entry_v1 struct {
	...
	Collectors *util.RawXml `xml:"collectors"`
}
...
func specify_v1(e Entry) interface{} {
	...
	if text, present := e.raw["collectors"]; present {
		ans.Collectors = &util.RawXml{text}
	}
